...
class CommandsControllerTest < ActionController::TestCase
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post :create, command: { description: @command.description, instruction: @command.instruction, tool_id: @command.tool_id, vulnerability_id: @command.vulnerability_id }
    end
  ...
  test "should update command" do
    patch :update, id: @command, command: { description: @command.description, instruction: @command.instruction, tool_id: @command.tool_id, vulnerability_id: @command.vulnerability_id }
    assert_redirected_to command_path(assigns(:command))
  end
